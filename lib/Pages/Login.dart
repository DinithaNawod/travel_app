...
class _LogInState extends State<LogIn> {
  ...
  userLogin() async {
    try {
      ...
      if (currentUser != null) {
        // Fetch user details from Firestore under UserTraveler collection
        var userSnapshot = await DatabaseMethods().getTravelerDetailsByEmail(email);
        ...
        if (userSnapshot.docs.isNotEmpty) {
          ...
          // Navigate to the next screen (Bottom Navigation)
          Navigator.pushReplacement(
            context,
            MaterialPageRoute(builder: (context) => const BottomNav()),
          );
        } else {
          // User data not found, display a message
