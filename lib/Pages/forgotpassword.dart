    ...
    return Scaffold(
      ...
      body: Container(child: Column(children: [
        ...
        Container(
          ...
          child: const Text("Password Recovery", style: TextStyle(color: Colors.white, fontSize: 30.0, fontWeight: FontWeight.bold,),
          ),
        ),
        const SizedBox(height: 10.0,),
        const Text("Enter Your Mail", style: TextStyle(
        ...
        child: ListView(
          children: [
            ...
            Row(
              ...
              children: [
                const Text("Don't have an account? ", style: TextStyle(fontSize: 20.0, color: Colors.white, ),),
                const SizedBox(width: 5.0,),
                GestureDetector(
                  onTap: (){
                    Navigator.push(context, MaterialPageRoute(builder: (context)=> const SignUp()));
                  },
                  child: const Text("Create",style: TextStyle(fontSize: 18.0, color: Color.fromARGB(255, 184, 166, 6),
